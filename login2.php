		...
		<div class="container" >
			<div class="form-signin" style="background: #BA55D3;">
				...
				<form method="POST" action="valida2.php">
					...
					<input type="submit" name="btnLogin" value="Logar" style="background-color: #9932CC; border-radius: 20px; color: white; font-family: Arial, Helvetica, sans-serif" class="btn btn-block">
